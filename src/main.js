...
export default {
  ...
  config: {
    ...
    "pages": ["^pages/index/main","pages/agentActivity/main","pages/myPayDetail/main", "pages/goods/main","pages/categorylist/main", "pages/feedback/main", "pages/order/main", "pages/fans/main", "pages/cart/main", "pages/mappage/main", "pages/collectlist/main", "pages/addressSelect/main", "pages/addaddress/main", "pages/address/main", "pages/search/main", "pages/my/main", "pages/login/main", "pages/category/main", "pages/topic/main",  "pages/logs/main", "pages/branddetail/main", "pages/brandlist/main", "pages/newgoods/main", "pages/practice/main", "pages/topicdetail/main"],
    "window": {
