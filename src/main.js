...
export default {
  ...
  config: {
    ...
    "pages": ["^pages/index/main", "pages/order/main","pages/agentActivity/main","pages/myPayDetail/main", "pages/goods/main","pages/categorylist/main", "pages/fans/main","pages/search/main", "pages/my/main","pages/category/main", ],
    "window": {
